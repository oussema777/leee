...
const content = {
  en: {
    ...
    successMessage: "Thank you for your interest in joining The LEE Experience. We will review your application and get back to you soon.",
  ...
  ar: {
    ...
    successMessage: "شكراً لاهتمامك بالانضمام إلى تجربة LEE. سنراجع طلبك ونعود إليك قريباً.",
