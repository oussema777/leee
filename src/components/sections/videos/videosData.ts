...
export const demoVideos: VideoItem[] = [
  ...
  {
    id: "2",
    titleEn: "NAWRA Green Ventures Pitch Competition Recap",
    titleAr: "ملخص مسابقة عروض مشاريع نورة الخضراء",
    descriptionEn: "Watch the highlights from the NAWRA pitch competition where 15 women-led green startups competed for seed funding across 3 MENA countries.",
  ...
  // Success Stories
  {
    ...
    descriptionEn: "Rima shares how the NAWRA program helped her launch a sustainable fashion brand in South Lebanon, creating jobs for 12 women.",
  ...
  {
    id: "9",
    titleEn: "Women Leading Change — Voices from NAWRA",
    titleAr: "نساء يقدن التغيير — أصوات من نورة",
    descriptionEn: "Three women entrepreneurs from Lebanon, Tunisia, and Morocco share their experiences with the NAWRA Green Ventures program.",
