...
export const demoPosts: BlogPost[] = [
  ...
  },
  {
    ...
    titleEn: "From an Idea to a Fashion Brand: Rima's Journey with NAWARA",
  ...
  },
  {
    ...
    titleEn: "LEE Partners with EU on Expanded ENABLE Programme",
    titleAr: "LEE تشترك مع الاتحاد الأوروبي في برنامج ENABLE الموسّع",
    ...
    authorNameEn: "LEE Communications",
    authorNameAr: "اتصالات LEE",
    authorRole: "Official",
