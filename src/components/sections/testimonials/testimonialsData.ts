...
export const demoTestimonials: TestimonialItem[] = [
  // Entrepreneurs
  {
    ...
    quoteEn: "The SIYB training gave me the tools to turn my passion for cooking into a real business. Today, my community kitchen serves 200 families daily in the Bekaa Valley. LEE didn't just teach me business — they believed in me when no one else did.",
    quoteAr: "منحني تدريب SIYB الأدوات لتحويل شغفي بالطبخ إلى عمل حقيقي. اليوم، مطبخي المجتمعي يخدم 200 عائلة يومياً في سهل البقاع. LEE لم تعلمني الأعمال فحسب — بل آمنوا بي عندما لم يؤمن بي أحد.",
  ...
  // Women Leaders
  {
    ...
    quoteEn: "NAWARA transformed my life. As a woman in South Lebanon, starting a green fashion business seemed impossible. The program gave me training, funding, and — most importantly — a community of women who lift each other up. We now employ 12 women.",
    ...
    programEn: "NAWARA Green Ventures",
  ...
  },
  {
    ...
    quoteEn: "The Houla factory gave us more than jobs — it gave us dignity. I went from being unemployed to managing a cooperative of 50 women producing sustainable fashion. LEE and UNIFIL made this dream a reality.",
    quoteAr: "أعطانا مصنع حولا أكثر من وظائف — أعطانا كرامة. انتقلت من البطالة إلى إدارة تعاونية من 50 امرأة تنتج أزياء مستدامة. جعلت LEE واليونيفيل هذا الحلم حقيقة.",
  ...
  // Partners & Donors
  {
    ...
    quoteAr: "LEE Experience هي واحدة من أكثر شركائنا المنفذين فعالية في المنطقة. تقديمهم لبرنامج SIYB عالي الجودة باستمرار ووصولهم إلى المجتمعات المحرومة لا مثيل له. نتائج برنامج ENABLE تجاوزت جميع أهدافنا.",
  ...
  },
  {
    ...
    quoteEn: "The EU's partnership with LEE on the ENABLE programme has been exemplary. Their ability to deliver certified entrepreneurship training at scale while maintaining quality and inclusivity is remarkable.",
    quoteAr: "شراكة الاتحاد الأوروبي مع LEE في برنامج ENABLE كانت نموذجية. قدرتهم على تقديم تدريب ريادة أعمال معتمد على نطاق واسع مع الحفاظ على الجودة والشمولية أمر رائع.",
